          ...
          <div className="grid grid-cols-1 md:space-y-16 md:mb-12">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl">
                  weviate is a vector database that stores and indexes data in a
                  vector space. It is a high-performance, scalable, and
          ...
          <div className="grid grid-cols-1 md:space-y-16 md:mb-12">
            ...
            >
              ...
              <div>
                ...
                <p className="text-xl">
                  An advanced AI technology for natural language processing and
                  understanding.
                </p>
              </div>
            </div>
